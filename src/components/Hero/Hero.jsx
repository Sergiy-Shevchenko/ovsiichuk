...
const rentServis = [
  ...
  { id: 2, name: 'інформаційна довідка з БТІ' },
  { id: 3, name: 'експертна оцінка нерухомості' },
  { id: 4, name: 'виготовлення технічного паспорту' },
  { id: 5, name: 'витяг з Державного земельного кадастру'},
];

const FullServiseList = ({ id, name }) => {
  return (
    <ul className={css.list}>
      {rentServis.map(({ id, name }) => (
